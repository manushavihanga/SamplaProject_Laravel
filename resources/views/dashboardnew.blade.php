...
<div class="header_section"style="background-image: url('{{ asset('build/assets/images/banner-bg.png') }}'); background-size: cover; background-position: center; height: 100vh;">
    <div class="container">
    ...
    <div class="banner_section layout_padding">
        <div id="my_slider" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-item active">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <img src="{{ asset('build/assets/images/img-1.png') }}" class="image_1" alt="Banner Image">
                            </div>
                        </div>
                        <div class="button_main">
                            <button class="all_text">All</button>
                            <input type="text" class="Enter_text" placeholder="Enter keywords">
            ...
            <a class="carousel-control-prev" href="#my_slider" role="button" data-slide="prev">
                <i><img src="{{ asset('build/assets/images/left-icon.png') }}" alt="Previous"></i>
            </a>
            <a class="carousel-control-next" href="#my_slider" role="button" data-slide="next">
                <i><img src="{{ asset('build/assets/images/right-icon.png') }}" alt="Next"></i>
            </a>
        </div>
    </div>
    <!-- Banner Section End -->
            ...
            <div class="row">
               <div class="col-lg-4 col-sm-12">
                  <div class="beds_section active">
                     ...
                     <div><img src="{{ asset('build/assets/images/img-2.png') }}" class="image_2"></div>
               ...
               <div class="col-lg-4 col-sm-12">
                  <div class="beds_section">
                     ...
                     <div><img src="{{ asset('build/assets/images/img-3.png') }}" class="image_2"></div>
                     <div class="seemore_bt"><a href="#">see More</a></div>
                  </div>
               </div>
               <div class="col-lg-4 col-sm-12">
                  <div class="beds_section">
                     ...
                     <div><img src="{{ asset('build/assets/images/img-4.png') }}" class="image_2"></div>
                     <div class="seemore_bt"><a href="#">see More</a></div>
                  </div>
               </div>
            </div>
               ...
               <div class="row">
                  <div class="col-sm-5">
                     <div class="feature_box">
                        ...
                        <div><img src="{{ asset('build/assets/images/img-7.png') }}" class="image_7"></div>
                     </div>
                  ...
                  <div class="col-sm-7">
                     <div class="feature_box_2">
                        <h1 class="readable_text">Readable content of</h1>
                        <div><img src="{{ asset('build/assets/images/img-8.png') }}" class="image_8"></div>
                        <div class="seemore_bt"><a href="#">see More</a></div>
                     </div>
                  </div>
               </div>
...
<div class="client_section layout_padding">
         <div id="main_slider" class="carousel slide" data-ride="carousel">
               ...
               <div class="carousel-item active">
                  <div class="container">
                     ...
                     <div class="client_section_2">
                        <div class="image_9"><img src="{{ asset('build/assets/images/img-9.png') }}"></div>
                        ...
                        <div class="image_9"><img src="{{ asset('build/assets/images/img-10.png') }}"></div>
                     </div>
                  </div>
               </div>
            ...
            <i class=""><img src="{{ asset('build/assets/images/left-icon.png') }}"></i>
            </a>
            <a class="carousel-control-next" href="#main_slider" role="button" data-slide="next">
            <i class=""><img src="{{ asset('build/assets/images/right-icon.png') }}"></i>
            </a>
         </div>
      </div>
      <!-- client section end -->
               ...
               <div class="col-lg-3 col-sm-6">
                  <div class="information_main">
                     ...
                     <div class="social_icon">
                        <ul>
                           <li><a href="#"><img src="{{ asset('build/assets/images/fb-icon.png') }}"></a></li>
                           <li><a href="#"><img src="{{ asset('build/assets/images/twitter-icon.png') }}"></a></li>
                           <li><a href="#"><img src="{{ asset('build/assets/images/linkedin-icon.png') }}"></a></li>
                           <li><a href="#"><img src="{{ asset('build/assets/images/instagram-icon.png') }}"></a></li>
                        </ul>
                     </div>
                  </div>
               </div>
